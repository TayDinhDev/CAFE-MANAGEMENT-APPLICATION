...
{
    public partial class fr_BC_Quy_SP : Form
    {
        public fr_BC_Quy_SP()
        {
            InitializeComponent();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            sql = @"SELECT  top(3)   tb_CTHDB.MaSP, SUM( tb_CTHDB.SoLuong) AS SL FROM tb_HDB INNER JOIN tb_CTHDB ON tb_HDB.MaHDB = tb_CTHDB.MaHDB where tb_HDB.NgayBan BETWEEN '" + d1.Text + "' AND '" + d2.Text + "' group by tb_CTHDB.MaSP order by SUM( tb_CTHDB.SoLuong) DESC";
